package com.asn.otgviewer_demo.util;
...
import com.asn.otgviewer_demo.MainActivity;
import com.asn.otgviewer_demo.R;
import com.asn.otgviewer_demo.application.OTGApplication;
...
public class Utils {
    ...
    // Android/data/com.asn.otgviewer_demo/files/Download/OTGViewer/
    public final static File otgViewerPath = new File(OTGApplication.getInstance().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS),"/OTGViewer");
    public final static File otgViewerCachePath = new File(OTGApplication.getInstance().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS),"/OTGViewer/cache");
